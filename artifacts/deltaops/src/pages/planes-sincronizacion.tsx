/**
 * DGP-012 · Panel de sincronización offline de Planes.
 * Reutiliza el framework offline (cola por tenant, espacio "planes"): cola
...
import type { Tono } from "../lib/planes/constantes";
...
export default function PlanesSincronizacionPage() {
  return (
    <ShellPlanes activo="/planes/sincronizacion">
      <Panel />
    </ShellPlanes>
  );
}
  ...
  return (
    <>
      <PageHeader
        ...
        descripcion="Cola de operaciones offline de planes y su estado de sincronización."
        acciones={
      ...
      >
        {operaciones.length === 0 ? (
          ...
          <Card>
            <CardContent>
              <Table caption="Cola de sincronización de planes">
                <thead>
