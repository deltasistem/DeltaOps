/**
 * DGP-014 · Panel de sincronización offline del módulo preventivo.
 * Reutiliza el framework offline (cola por tenant, espacio "preventivo"): cola
...
import type { Tono } from "../lib/preventivo/constantes";
...
export default function PreventivoSincronizacionPage() {
  return (
    <ShellPreventivo activo="/preventivo/sincronizacion">
      <Panel />
    </ShellPreventivo>
  );
}
  ...
  return (
    <>
      <PageHeader
        ...
        descripcion="Cola de operaciones offline del preventivo y su estado de sincronización."
        acciones={
      ...
      >
        {operaciones.length === 0 ? (
          ...
          <Card>
            <CardContent>
              <Table caption="Cola de sincronización del preventivo">
                <thead>
