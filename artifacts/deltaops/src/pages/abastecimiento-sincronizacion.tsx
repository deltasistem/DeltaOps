/**
 * DGP-013 · Panel de sincronización offline de Abastecimiento.
 * Reutiliza el framework offline (cola por tenant, espacio "abastecimiento"):
 * cola visible, estado de sync, reintentos, resolución de conflictos y purga.
 */
import React from "react";
import {
  PageHeader, Section, Card, CardContent, Table, Badge, Button, OfflineBadge, EmptyState, KpiCard,
...
import type { Tono } from "../lib/abastecimiento/constantes";
...
export default function AbastecimientoSincronizacionPage() {
  return (
    <ShellAbastecimiento activo="/abastecimiento/sincronizacion">
      <Panel />
    </ShellAbastecimiento>
  );
}
  ...
  return (
    <>
      <PageHeader
        ...
        descripcion="Cola de operaciones offline de abastecimiento y su estado de sincronización."
        acciones={
      ...
      >
        {operaciones.length === 0 ? (
          ...
          <Card>
            <CardContent>
              <Table caption="Cola de sincronización de abastecimiento">
                <thead>
