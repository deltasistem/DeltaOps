/**
 * DGP-011.3 · Panel de sincronización offline de Inventario.
 * Reutiliza el framework offline (cola por tenant, espacio "inventario"): cola
...
import type { Tono } from "../lib/inventario/constantes";
...
export default function InventarioSincronizacionPage() {
  return (
    <ShellInventario activo="/inventario/sincronizacion">
      <Panel />
    </ShellInventario>
  );
}
  ...
  return (
    <>
      <PageHeader
        ...
        descripcion="Cola de operaciones offline de inventario y su estado de sincronización."
        acciones={
      ...
      >
        {operaciones.length === 0 ? (
          ...
          <Card>
            <CardContent>
              <Table caption="Cola de sincronización de inventario">
                <thead>
