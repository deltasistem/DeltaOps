/**
 * DGP-009.3 · Panel de sincronización offline de Órdenes.
 * Reutiliza el framework offline (cola por tenant con espacio de nombres
 * "ordenes"): cola visible, estado de sync, reintentos, resolución de
 * conflictos (descartar) y purga de operaciones exitosas.
 */
...
export default function OrdenesSincronizacionPage() {
  return (
    <ShellOrdenes activo="/ordenes/sincronizacion">
      <Panel />
    </ShellOrdenes>
  );
}
    ...
    <>
      ...
      >
        {operaciones.length === 0 ? (
          ...
          <Card>
            <CardContent>
              <DoTable caption="Cola de sincronización de órdenes">
                <thead>
